...
# Define a timeout for detecting silence (in seconds)
SILENCE_TIMEOUT = 1.0
...
def listen_print_loop(responses: object) -> str:
    ...
    # Initialize a timer to track silence
    silence_timer = None
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            # Reset the silence timer when there is new speech
            ...
            # Check for silence
            if silence_timer is not None and time.time() - silence_timer >= SILENCE_TIMEOUT:
                print("Silence detected. End of sentence.")
                break

            # Check for keywords 'over,' 'bro,' or 'exit'
            if re.search(r'\b(over|bro|exit)\b', new_transcript, re.I):
                print("Keyword detected. End of transcript.")
                break
